...
if (!document.getElementById(styleId)) {
  ...
  style.textContent = `
    ds-spinner {
      display: inline-flex;
      width: var(--ds-component-icon-size-sm, 16px);
      height: var(--ds-component-icon-size-sm, 16px);
      align-items: center;
    ...
    ds-spinner[size="medium"] {
      width: var(--ds-component-icon-size-md, 20px);
      height: var(--ds-component-icon-size-md, 20px);
    }

    ds-spinner[size="large"] {
      width: var(--ds-component-icon-size-lg, 24px);
      height: var(--ds-component-icon-size-lg, 24px);
    }
